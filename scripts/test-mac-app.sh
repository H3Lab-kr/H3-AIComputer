...
swiftc -parse-as-library "$ROOT/apps/macos/Sources/AIComputer/Localization.swift" "$ROOT/apps/macos/Sources/AIComputer/ComputerControl.swift" "$ROOT/apps/macos/Tests/AIComputerTests/ComputerTests.swift" -o "$TEST_DIR/computer-tests"
"$TEST_DIR/computer-tests"
