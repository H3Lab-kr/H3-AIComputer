...
컴퓨터의 정교한 내부부터 책상 위 창작 환경, 연결된 장치의 미래까지. 홈페이지의 3D 제품 디자인을 담은 브랜드 필름입니다. 아래에서 한국어·영어 영상을 바로 재생할 수 있습니다.
...
![H3 데스크톱 실제 화면](apps/web/public/brand/h3-desktop-preview-04.png)
...
<p align="center"><sub>‘AI 컴퓨터’는 정락현, 문아라, 이강훈이 공동으로 브랜딩하여 시작했습니다. 공동 브랜딩 시작일: 2026-09-08.<br>© 2026 정락현 · 문아라 · 이강훈 — AI 컴퓨터 브랜드 기획·브랜딩.</sub></p>
